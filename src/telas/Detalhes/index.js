...
export default function Detalhes(props) {
  ...
  const posicao = useSharedValue(0); //altera posicao do bloco

  const estiloAnimado = useAnimatedStyle(() => {
    return {
      transform: [
        {
          translateX: withSpring(posicao.value) //pega o valor da posicao e altera no estivo, withSpring deixa transicao mais suave
        }
      ]
    }
  })
    ...
    <TelaDeFundo>
      <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
        ...
        <Animated.View style={[{ backgroundColor: 'green',
          width: 50, height: 50 }, estiloAnimado]} />
