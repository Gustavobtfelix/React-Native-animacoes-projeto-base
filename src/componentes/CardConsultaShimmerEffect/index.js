    ...
    <View style={styles.container}>
      <View style={styles.pessoaArea}>
        <Image source={shimmerGif} style={[styles.foto, 
          { overlayColor: '#FFF'}]}/* overlayColor é um css aplicado ao gif para criar a borda */ /> 
        <View style={styles.informacoes}>
        <Image source={shimmerGif} style={{ width: 200, 
          height: 25 }}/>
          <View style={styles.consultaArea}>
          <Image source={shimmerGif} style={{ width: 100, 
          height: 15, marginTop: 5 }}/>
          </View>
        </View>
      </View>
      ...
      <Image source={shimmerGif} style={{ width: 100, 
        ...
        <Image source={shimmerGif} style={{ width: '100%', 
          height: 50, borderRadius: 10, overlayColor: '#FFF' }}/>  
        </View>
      </View>
    </View>
  );
